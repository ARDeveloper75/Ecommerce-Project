...
class AddCatagoryPage extends StatelessWidget {
    ...
    return Center(
      child: Container(
        ...
        child: TextField(
          ...
          onChanged: _.addCatagoryC.title,
          ...
          decoration: InputDecoration(
            ...
            // ),
            labelText: 'Enter your catagory name',
    ...
    return Center(
      child: Container(
        ...
        child: TextField(
          ...
          onChanged: _.addCatagoryC.image,
          cursorColor: Colors.green,
          style: GoogleFonts.lato(
            color: Colors.black,
            fontWeight: FontWeight.bold,
          ...
          decoration: InputDecoration(
            ...
            //   color: HexColor('3D4584'),
            // ),
            labelText: 'Enter your catagory image',
            labelStyle: GoogleFonts.lato(
              color: Colors.grey,
              fontSize: 16,
              fontWeight: FontWeight.bold,
